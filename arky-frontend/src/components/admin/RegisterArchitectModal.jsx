...
export default function RegisterArchitectModal({ isOpen, onClose, token, onSuccess }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            showToast('Arquitecto registrado exitosamente', 'success');
            if (onSuccess) onSuccess();
        } catch (error) {
            showToast(error.response?.data?.message || 'Error al registrar arquitecto', 'error');
        } finally {
            setIsLoading(false);
        }
    };
                            ...
                            <div className="space-y-4">
                                <div className="bg-green-50 dark:bg-green-900/50 p-4 rounded-md">
                                    ...
                                    <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">
                                        Comparte esta contraseña con el arquitecto de forma segura.
                                    </p>
                                </div>
